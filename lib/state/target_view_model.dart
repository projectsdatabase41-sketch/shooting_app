...
class TargetViewModel extends ChangeNotifier {
  ...
  /// Для правок МИМО этой вью-модели — например, добавление
  /// комментария к выстрелу пишется прямо в БД через
  /// `CommentsRepository`, не через `_persist()`, и без этого вызова
  /// осталось бы незамеченным для подтверждения при выходе.
